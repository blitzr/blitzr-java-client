...
public class Client {
    ...
    public Generator<Artist> getArtistBandsGenerator(String slug, String uuid, Integer start, Integer limit)
    {
    ...
    public Generator<Event> getArtistEventsGenerator(String slug, String uuid, Integer start, Integer limit)
    {
    ...
    public Generator<Artist> getArtistMembersGenerator(String slug, String uuid, Integer start, Integer limit)
    {
        return new Generator<Artist>() {
            @Override
            protected void run() throws InterruptedException {
    ...
    public Generator<Artist> getArtistRelatedGenerator(String slug, String uuid, Integer start, Integer limit)
    {
        return new Generator<Artist>() {
            @Override
            protected void run() throws InterruptedException {
    ...
    public Generator<Release> getArtistReleasesGenerator(String slug, String uuid, Integer start, Integer limit, ReleaseType type, ReleaseFormat format, Boolean credited)
    {
    ...
    public Generator<Artist> getArtistSimilarGenerator(String slug, String uuid, ArrayList<String> filters, Integer start, Integer limit)
    {
        return new Generator<Artist>() {
            @Override
            protected void run() throws InterruptedException {
    ...
    public Generator<Event> getEventsGenerator(String countryCode, Float latitude, Float longitude, String city, String venue, String tag, Date dateStart, Date dateEnd, Integer radius, Integer start, Integer limit)
    {
        return new Generator<Event>() {
            @Override
            protected void run() throws InterruptedException {
    ...
    public Generator<Label> getLabelArtistsGenerator(String slug, String uuid, Integer start, Integer limit)
    {
    ...
    public Generator<Release> getLabelReleasesGenerator(String slug, String uuid, ReleaseFormat format, Integer start, Integer limit)
    {
        return new Generator<Release>() {
            @Override
            protected void run() throws InterruptedException {
    ...
    public Generator<Label> getLabelSimilarGenerator(String slug, String uuid, ArrayList<String> filters, Integer start, Integer limit)
    {
        return new Generator<Label>() {
            @Override
            protected void run() throws InterruptedException {
    ...
    public Generator<Artist> searchArtistGenerator(String query, ArrayList<String> filters, Boolean autocomplete, Integer start, Integer limit)
    {
        return new Generator<Artist>() {
            @Override
            protected void run() throws InterruptedException {
    ...
    public Generator<City> searchCityGenerator(String query, Boolean autocomplete, Float latitude, Float longitude, Integer start, Integer limit)
    {
    ...
    public Generator<Country> searchCountryGenerator(String country_code, Integer start, Integer limit)
    {
    ...
    public Generator<Label> searchLabelGenerator(String query, ArrayList<String> filters, Boolean autocomplete, Integer start, Integer limit)
    {
        return new Generator<Label>() {
            @Override
            protected void run() throws InterruptedException {
    ...
    public Generator<Release> searchReleaseGenerator(String query, ArrayList<String> filters, Boolean autocomplete, Integer start, Integer limit)
    {
        return new Generator<Release>() {
            @Override
            protected void run() throws InterruptedException {
    ...
    public Generator<Track> searchTrackGenerator(String query, ArrayList<String> filters, Integer start, Integer limit)
    {
    ...
    public Generator<Artist> getTagArtistsGenerator(String slug, Integer start, Integer limit)
    {
        return new Generator<Artist>() {
            @Override
            protected void run() throws InterruptedException {
    ...
    public Generator<Release> getTagReleasesGenerator(String slug, Integer start, Integer limit)
    {
        return new Generator<Release>() {
            @Override
            protected void run() throws InterruptedException {
